...
contextBridge.exposeInMainWorld('mysqlApi', {
  ...
  getRoutineParameters: (database: any, routineName: any, routineType: 'FUNCTION' | 'PROCEDURE') => ipcRenderer.invoke('mysql:getRoutineParameters', database, routineName, routineType),
  executeRoutine: (database: any, routineName: any, routineType: 'FUNCTION' | 'PROCEDURE', args: any[]) => ipcRenderer.invoke('mysql:executeRoutine', database, routineName, routineType, args),
